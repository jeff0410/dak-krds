		...
		<Table
			...
			customTableOption={{
				...
				muiTableBodyRowProps: (params) => {
					const existingProps =
						tableProps.customTableOption?.muiTableBodyRowProps;
					const baseProps =
						typeof existingProps === "function"
							? existingProps(params)
							: existingProps || {};
					...
					return {
						...
						sx: {
							...
							...(isLastInGroup && {
								"& td": {
									borderBottom:
										"1px solid var(--krds-color-gray-20) !important",
								},
							}),
						},
					};
				...
				muiTableBodyCellProps: (params) => {
					...
					const existingProps =
						tableProps.customTableOption?.muiTableBodyCellProps;
					const baseProps =
						typeof existingProps === "function"
							? existingProps(params)
							: existingProps || {};
