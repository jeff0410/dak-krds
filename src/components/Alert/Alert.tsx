...
export const Alert = ({
	...
	return (
		<div
			className={`${styles.alertContainer} ${variantClass} ${className ?? ""}`}
			...
			<div className={styles.content}>
				{title && (
					<div className={styles.titleRow}>
						<span className={`${styles.title} ${titleColorClass}`}>
							{title}
						</span>
					</div>
				)}
				{description && (
					<div
						className={title ? styles.descriptionIndented : styles.description}
					>
						{description}
					</div>
				)}
