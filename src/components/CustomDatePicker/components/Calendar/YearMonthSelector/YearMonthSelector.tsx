...
import { useCustomYearMonthSelector } from '../../../hooks';
...
export function CustomYearMonthSelector({
  currentDate,
  minYear = 2000,
  maxYear = 2030,
  onYearChange,
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.selector} ref={yearSelectorRef}>
        <button className={styles.selectorButton} onClick={handleYearToggle}>
      ...
      <div className={styles.selector} ref={monthSelectorRef}>
        <button className={styles.selectorButton} onClick={handleMonthToggle}>
